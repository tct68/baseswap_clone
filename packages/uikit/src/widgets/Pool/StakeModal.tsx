...
import { formatNumber, getDecimalAmount, getFullDisplayBalance } from "@baseswap/utils/formatBalance";
import removeTrailingZeros from "@baseswap/utils/removeTrailingZeros";
