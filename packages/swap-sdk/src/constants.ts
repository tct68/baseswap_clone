...
export const FACTORY_ADDRESS_MAP: Record<number, string> = {
  ...
  [ChainId.LINEA_TESTNET]: '0x93E76C9f0D85cC664A8c1BD608fb0C309aBfAed0',
}
...
export const INIT_CODE_HASH_MAP: Record<number, string> = {
  ...
  [ChainId.LINEA_TESTNET]: '0x5d78f82d759c2c59333a1132c73e9aaf0d090e64de1e1b8d508c5bcee2ffbbbc',
}
...
export const WBNB = {
  ...
  [ChainId.LINEA_TESTNET]: new ERC20Token(
    ...
    '0xc0aBFB178DBeafBBDdEc74B3A3cc938df8E515d7',
    18,
    'WETH',
    'Wrapped ETH',
    'https://linea.build'
...
export const WNATIVE: Record<number, ERC20Token> = {
  ...
  [ChainId.LINEA_TESTNET]: WBNB[ChainId.LINEA_TESTNET],
}
...
> = {
  ...
  [ChainId.LINEA_TESTNET]: { name: 'Ethereum', symbol: 'ETH', decimals: 18 },
}
