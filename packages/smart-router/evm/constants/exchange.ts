...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.GOERLI]: [WNATIVE[ChainId.RINKEBY], USDC[ChainId.GOERLI], BUSD[ChainId.RINKEBY]],
  [ChainId.BSC]: [
    bscTokens.wbnb,
    bscTokens.cake,
    bscTokens.busd,
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.RINKEBY]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.RINKEBY], BUSD[ChainId.RINKEBY]],
