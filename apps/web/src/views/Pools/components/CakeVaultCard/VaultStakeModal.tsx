...
import { getFullDisplayBalance, formatNumber, getDecimalAmount } from '@baseswap/utils/formatBalance'
import useCatchTxError from 'hooks/useCatchTxError'
import { fetchCakeVaultUserData } from 'state/pools'
import { VaultKey } from 'state/types'
import { getInterestBreakdown } from '@baseswap/utils/compoundApyHelpers'
import { ToastDescriptionWithTx } from 'components/Toast'
import { vaultPoolConfig } from 'config/constants/pools'
import { getFullDecimalMultiplier } from '@baseswap/utils/getFullDecimalMultiplier'
