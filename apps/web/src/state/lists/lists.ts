import { createListsAtom, createTokenListReducer, NEW_LIST_STATE } from '@baseswap/token-lists/react'
...
export const { listsAtom, useListState, useListStateReady } = createListsAtom('listv2', listReducer, initialState)
