...
export const EXCHANGE_DOCS_URLS = 'https://towerswap.gitbook.io/towerswap-finance/product'
export const EXCHANGE_HELP_URLS = 'https://towerswap.gitbook.io/towerswap-finance/product'
